...
class HandCloseTest():
    def __init__(self, controller='/r_hand_controller'):
        self.controller = controller
        self.goal_pub = rospy.Publisher(controller+'/command', Float64)
        self.state_sub = rospy.Subscriber(controller+'/state', Float64, self.state_cb)
